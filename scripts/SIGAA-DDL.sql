...
--------------------------------------------------------
CREATE TABLE public."SIGAA_UNIDADE"
(
...
CREATE UNIQUE INDEX "PK_SIGAA_UNIDADE" ON public."SIGAA_UNIDADE" ("ID");

--------------------------------------------------------
--  DDL for Table SIGAA_DISCIPLINA
--------------------------------------------------------
CREATE TABLE public."SIGAA_DISCIPLINA" 
(
    ...
    CONSTRAINT "FK_UNIDADE" FOREIGN KEY ("UNIDADE")
        REFERENCES public."SIGAA_UNIDADE" ("ID")
);

CREATE UNIQUE INDEX "PK_SIGAA_DISCIPLINA" ON public."SIGAA_DISCIPLINA" ("ID");
  
--------------------------------------------------------
--  DDL for Table SIGAA_PREREQ
--------------------------------------------------------
CREATE TABLE public."SIGAA_PREREQ" 
(
    ...
    CONSTRAINT "FK_DISCIPLINA_REQUER" FOREIGN KEY ("DISCIPLINA_REQUER")
        REFERENCES public."SIGAA_DISCIPLINA" ("ID"),
...
--------------------------------------------------------
CREATE TABLE public."SIGAA_CURSO"
(
...
CREATE UNIQUE INDEX "PK_SIGAA_CURSO" ON public."SIGAA_CURSO" ("ID");

--------------------------------------------------------
--  DDL for Table SIGAA_RL_CURSO_UNIDADE
--------------------------------------------------------
CREATE TABLE public."SIGAA_RL_CURSO_UNIDADE"
(
    ...
    CONSTRAINT "FK_CURSO" FOREIGN KEY ("CURSO")
        REFERENCES public."SIGAA_CURSO" ("ID")
);

--------------------------------------------------------
--  DDL for Table SIGAA_CURRICULO
--------------------------------------------------------
CREATE TABLE public."SIGAA_CURRICULO"
(
    "ID" character varying(7) NOT NULL,
...
CREATE UNIQUE INDEX "PK_SIGAA_CURRICULO" ON public."SIGAA_CURRICULO" ("ID");

--------------------------------------------------------
--  DDL for Table SIGAA_RL_CURRICULO_CURSO
--------------------------------------------------------
CREATE TABLE public."SIGAA_RL_CURRICULO_CURSO"
(
    ...
    CONSTRAINT "FK_CURRICULO" FOREIGN KEY ("CURRICULO")
        REFERENCES public."SIGAA_CURRICULO" ("ID")
);

--------------------------------------------------------
--  DDL for Table SIGAA_RL_CURRICULO_DISCIPLINA
--------------------------------------------------------
CREATE TABLE public."SIGAA_RL_CURRICULO_DISCIPLINA" 
(
    "CURRICULO" character varying(7) NOT NULL,
...
--------------------------------------------------------
CREATE TABLE public."SIGAA_TURMA" 
(
    "ID" serial,
...
CREATE UNIQUE INDEX "PK_SIGAA_TURMA" ON public."SIGAA_TURMA" ("ID");
...
(
    ...
    CONSTRAINT "FK_HORARIOAULA" FOREIGN KEY ("HORARIOAULA")
        REFERENCES public."SIGAA_TURMA_HORARIOAULA" ("ID"),
    CONSTRAINT "FK_TURMA" FOREIGN KEY ("TURMA")
        REFERENCES public."SIGAA_TURMA" ("ID")
);
...
CREATE UNIQUE INDEX "PK_SIGAA_ALUNO" ON public."SIGAA_ALUNO" ("MATRICULA");
...
(
    ...
    CONSTRAINT "FK_ALUNO" FOREIGN KEY ("ALUNO")
        REFERENCES public."SIGAA_ALUNO" ("MATRICULA"),
    CONSTRAINT "FK_CURSO" FOREIGN KEY ("CURSO")
        REFERENCES public."SIGAA_CURSO" ("ID"),
    CONSTRAINT "FK_CURRICULO" FOREIGN KEY ("CURRICULO")
        REFERENCES public."SIGAA_CURRICULO" ("ID")
...
(
    ...
    CONSTRAINT "FK_ALUNO_CURSO" FOREIGN KEY ("ALUNO_CURSO")
        REFERENCES public."SIGAA_RL_ALUNO_CURSO" ("ID"),
    CONSTRAINT "FK_DISCIPLINA" FOREIGN KEY ("DISCIPLINA")
        REFERENCES public."SIGAA_DISCIPLINA" ("ID")
);
...
(
    ...
    CONSTRAINT "FK_MATRICULA_STATUS" FOREIGN KEY ("STATUS")
        REFERENCES public."SIGAA_MATRICULA_STATUS" ("ID")
); 

CREATE UNIQUE INDEX "PK_SIGAA_MATRICULA" ON public."SIGAA_MATRICULA" ("ID");
...
CREATE UNIQUE INDEX "PK_SIGAA_MATRICULA_HISTORICO" ON public."SIGAA_MATRICULA_HISTORICO" ("ID");